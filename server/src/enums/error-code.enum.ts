 ...
 */
function mapStripeErrorToCode(stripeErrorType: StripeErrorType, declineCode?: string): ErrorCode {
...
export { ErrorCode, mapStripeErrorToCode, stripeDeclineCodeMap, StripeErrorType };
